...
class Admin::CollectionPresenter
  ...
  def managers
    puts "managers #{document.id}: edit_access_person_ssim: #{document["edit_access_person_ssim"].inspect} \n collection_managers_ssim: #{document["collection_managers_ssim"].inspect}"
